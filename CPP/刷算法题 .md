...
![image-20240507103712843](/home/sbim/.config/Typora/typora-user-images/image-20240507103712843.png)   
...
public:
    ...
    void backlink(int n,int k,int startindex)
    {
        //终止条件
        if(path.size()==2)
        {
          resulit.push_back(path);
          return ;  
        }
        ...
        for(int i=startindex;i<=n;i++)
        {
            path.push_back(i);
            backlink(n,k,i+1);
            path.pop_back(it.push_back(path);
          return;   
        }    
    }
